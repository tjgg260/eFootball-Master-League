...
def write_cs(formations: list[dict], dry: bool) -> None:
    lines = [
        ...
        "// </auto-generated>",
        "",
        "// The project is nullable-enabled, but the compiler treats an <auto-generated> file as",
        "// oblivious unless it says otherwise — NameFor's string? is a warning (CS8669) without this.",
        "#nullable enable",
        "",
